...
$routes->group('admin', ['filter' => 'estaLogado'], static function ($routes) {
    ...
    $routes->get('noticias/show/(:segment)/(:segment)', 'NoticiasController::show/$1/$2', ['as' => 'admin.noticias.show.2p']);
    $routes->get('noticias/show/(:segment)', 'NoticiasController::show/$1', ['as' => 'admin.noticias.show.1p']);
